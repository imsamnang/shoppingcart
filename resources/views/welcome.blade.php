...
<body class="cms-index-index index-opt-1">
  <div class="wrapper">
    <!-- alert banner top -->
    <div role="alert" class="qc-top-site qc-top-site1 alert  fade in" style="background-image: url(assets/front/images/media/index1/bg-qc-top.jpg);"> 
      <div class="container">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-3 nav-left">
              ...
              <!-- logo -->
              <strong class="logo">
                <a href="#"><img src="{{asset('assets/front/images/media/index1/logo.png')}}" alt="logo"></a>
              </strong>
                        ...
                        <ol class="minicart-items">
                          <li class="product-item">
                            <a class="product-item-photo" href="#" title="The Name Product">
                              <img class="product-image-photo" src="{{asset('assets/front/images/media/index1/minicart.jpg')}}" alt="The Name Product">
                            </a>
                          ...
                          <li class="product-item">
                            <a class="product-item-photo" href="#" title="The Name Product">
                              <img class="product-image-photo" src="{{asset('assets/front/images/media/index1/minicart2.jpg')}}" alt="The Name Product">
                            </a>
                            <div class="product-item-details">
                              <strong class="product-item-name">
                                <a href="#">Donec Ac Tempus</a>
      ...
      <div class="block-nav-categori">
        ...
        <div class="block-content">
          ...
          <ul class="ui-categori">
            <li class="parent">
              <a href="#">
                <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat1.png')}}" alt="nav-cat"></span>
                Electronics
              </a>
              <span class="toggle-submenu"></span>
              <div class="submenu" style="background-image: url(assets/front/images/media/index1/bgmenu.jpg);">
            ...
            <li class="parent">
              <a href="#">
                <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat2.png')}}" alt="nav-cat"></span>
                Sports & Outdoors
              </a>
              <span class="toggle-submenu"></span>
              <div class="submenu">
                <div class="categori-img">
                  <a href="#"><img src="{{asset('assets/front/images/media/index1/categori-img1.jpg')}}" alt="categori-img"></a>
                </div>
            ...
            <li class="parent">
              <a href="#">
                <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat3.png')}}" alt="nav-cat"></span>
                Smartphone & Tablets
              </a>
              <span class="toggle-submenu"></span>
              <div class="submenu">
              ...
              <div class="product-item product-item-opt-1">
                <div class="product-item-info">
                  <div class="product-item-photo">
                    <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/product-menu1.jpg')}}"></a>
                  </div>
              ...
              <div class="product-item product-item-opt-1">
                <div class="product-item-info">
                  <div class="product-item-photo">
                    <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/product-menu2.jpg')}}"></a>
                  </div>
                  <div class="product-item-detail">
              ...
              <div class="product-item product-item-opt-1">
                <div class="product-item-info">
                  <div class="product-item-photo">
                    <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/product-menu3.jpg')}}"></a>
                  </div>
                  <div class="product-item-detail">
              ...
              <div class="product-item product-item-opt-1">
                <div class="product-item-info">
                  <div class="product-item-photo">
                    <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/product-menu4.jpg')}}"></a>
                  </div>
                  <div class="product-item-detail">
                    <strong class="product-item-name"><a href="#">Electronics Ispiron 20 </a></strong>
                    <div class="product-item-price">
        ...
        <li>
          <a href="#">
            <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat4.png')}}" alt="nav-cat"></span>
            Health & Beauty
          </a>
        </li>
        <li>
          <a href="#">
            <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat5.png')}}" alt="nav-cat"></span>
            Bags, Shoes & Accessories
          </a>
        </li>
        <li>
          <a href="#">
            <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat6.png')}}" alt="nav-cat"></span>
            Toys & Hobbies
          </a>
        </li>
        <li>
          <a href="#">
            <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat7.png')}}" alt="nav-cat"></span>
            Computers & Networking
          </a>
        </li>
        <li>
          <a href="#">
            <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat8.png')}}" alt="nav-cat"></span>
            Laptops & Accessories
          </a>
        </li>
        <li>
          <a href="#">
            <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat9.png')}}" alt="nav-cat"></span>
            Jewelry & Watches
          </a>
        </li>
        <li>
          <a href="#">
            <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat10.png')}}" alt="nav-cat"></span>
            Flashlights & Lamps
          </a>
        </li>
          ...
          <ul>
            <li class="col-md-3">
              <div class="img-categori">
                <a href="#"><img alt="img" src="{{asset('assets/front/images/media/index1/img-categori1.jpg')}}"></a>
              </div>
            ...
            <li class="col-md-3">
              ...
              <div class="img-categori">
                <a href="#"><img  alt="img"  src="{{asset('assets/front/images/media/index1/img-categori2.jpg')}}"></a>
              </div>
              <strong class="title"><a href="#"><span>Women's </span></a></strong>
              <ul class="list-submenu">
                <li><a href="#">Shoes</a></li>
            ...
            <li class="col-md-3">
              ...
              <div class="img-categori">
                <a href="#"><img alt="img"  src="{{asset('assets/front/images/media/index1/img-categori3.jpg')}}"></a>
              </div>
            ...
            <li class="col-md-3">
              ...
              <div class="img-categori">
                <a href="#"><img alt="img"  src="{{asset('assets/front/images/media/index1/img-categori4.jpg')}}"></a>
              </div>
      ...
      <li class="parent parent-megamenu">
        ...
        <div class="megamenu drop-menu">
          <ul>
            ...
            <li class="col-md-3">
              <div class="img-categori">
                <a href="#"><img alt="img" src="{{asset('assets/front/images/media/index1/img-categori5.jpg')}}"></a>
              </div>
  ...
  <div class="dropdown-menu  ">
    <div class="switcher  switcher-language">
      ...
      <ul class="switcher-options ">
        <li class="switcher-option">
          <a href="#">
            <img class="switcher-flag" alt="flag" src="{{asset('assets/front/images/flags/flag_french.png')}}">
          </a>
        </li>
        <li class="switcher-option">
          <a href="#">
            <img class="switcher-flag" alt="flag" src="{{asset('assets/front/images/flags/flag_germany.png')}}">
          </a>
        </li>
        <li class="switcher-option">
          <a href="#">
        ...
        <li class="switcher-option switcher-active">
          <a href="#">
            <img class="switcher-flag" alt="flag" src="{{asset('assets/front/images/flags/flag_spain.png')}}">
          </a>
        </li>
      </ul>
    </div>
...
<main class="site-main">
  ...
  <div class="modal fade popup-newsletter" id="popup-newsletter" tabindex="-1" role="dialog" >
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="background-image: url(assets/front/images/media/index1/Popup.jpg);">
  ...
  <div class="block-section-top block-section-top1">
    <div class="container">
      <div class="box-section-top">
        ...
        <div class="block-nav-categori">
          ...
          <li>
            <a href="#">
              <span class="icon"><img src="{{asset('assets/front/images/icon/index1/nav-cat11.png')}}" alt="nav-cat"></span>
              Cameras & Photo
            </a>
          </li>
          <li class="cat-link-orther">
    ...
    <div class="block-slide-main slide-opt-1">
      ...
      data-autoplay="true" 
      data-loop="true">
      <div class="item item2" style="background-image: url(assets/front/images/media/index1/slide2.jpg);" data-dot="1">
      ...
      <div class="item item1" style="background-image: url(assets/front/images/media/index1/slide1.jpg);" data-dot="2">
      ...
      <div class="item item3" style="background-image: url(assets/front/images/media/index1/slide3.jpg);" data-dot="3">
  ...
  <div class="banner-slide">
    <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner-slide1.jpg')}}" alt="banner-slide"></a>
    <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner-slide2.jpg')}}" alt="banner-slide"></a>
  </div><!-- banner -->
      ...
      <div class="block-tab-products-opt1">
        ...
        <div class="block-content tab-content">
          ...
          <div class="product-item  product-item-opt-1 ">
            <div class="product-item-info">
              <div class="product-item-photo">
                <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/sellers1.jpg')}}"></a>
                <div class="product-item-actions">
          ...
          <div class="product-item  product-item-opt-1 ">
            <div class="product-item-info">
              <div class="product-item-photo">
                <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/sellers2.jpg')}}"></a>
                <div class="product-item-actions">
                  <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                  <a class="btn btn-compare" href="#"><span>compare</span></a>
                  <a class="btn btn-quickview" href="#"><span>quickview</span></a>
          ...
          <div class="product-item  product-item-opt-1 ">
            <div class="product-item-info">
              <div class="product-item-photo">
                <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/sellers3.jpg')}}"></a>
                <div class="product-item-actions">
                  <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                  <a class="btn btn-compare" href="#"><span>compare</span></a>
                  <a class="btn btn-quickview" href="#"><span>quickview</span></a>
...
<div class="col-md-3">
  ...
  <div class="block-deals-of block-deals-of-opt1">
    ...
    <div class="product-item  product-item-opt-1 ">
      ...
      <div class="product-item-info">
        <div class="product-item-photo">
          <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/deals-of1.jpg')}}" ></a>
          <div class="product-item-actions">
            <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
            <a class="btn btn-compare" href="#"><span>compare</span></a>
            <a class="btn btn-quickview" href="#"><span>quickview</span></a>
    ...
    <div class="product-item  product-item-opt-1 ">
      ...
      <div class="product-item-info">
        <div class="product-item-photo">
          <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/deals-of2.jpg')}}" ></a>
          <div class="product-item-actions">
            <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
            <a class="btn btn-compare" href="#"><span>compare</span></a>
            <a class="btn btn-quickview" href="#"><span>quickview</span></a>
    ...
    <div class="product-item  product-item-opt-1 ">
      ...
      <div class="product-item-info">
        <div class="product-item-photo">
          <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/deals-of3.jpg')}}" ></a>
          <div class="product-item-actions">
            <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
            <a class="btn btn-compare" href="#"><span>compare</span></a>
            <a class="btn btn-quickview" href="#"><span>quickview</span></a>
...
<div class="clearfix" style="background-color: #eeeeee;margin-bottom: 40px; padding-top:30px;">
  ...
  <div class="block-floor-products block-floor-products-opt1 floor-products1" id="floor0-1">
    <div class="container">
      <div class="block-title ">
        <span class="title"><img alt="img"  src="{{asset('assets/front/images/media/index1/floor1.png')}}">Fashion</span>
      ...
      <div class="block-banner-floor">
        ...
        <div class="col-sm-6">
          <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner1-1.jpg')}}" alt="banner"></a>
        </div>
        <div class="col-sm-6">
          <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner1-2.jpg')}}" alt="banner"></a>
        </div>
      ...
      <div class="block-content">
        ...
        <div class="col-banner">
          <span class="label-featured"><img src="{{asset('assets/front/images/icon/index1/label-featured.png')}}" alt="label-featured"></span>
          <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/baner-floor1.jpg')}}" alt="baner-floor"></a>
        </div>
        ...
        <div class="col-products tab-content">
          ...
          <div class=" product-item  product-item-opt-1 ">
            <div class="product-item-info">
              <div class="product-item-photo">
                <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor1-1.jpg')}}"></a>
                <div class="product-item-actions">
                  <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                  <a class="btn btn-compare" href="#"><span>compare</span></a>
                  <a class="btn btn-quickview" href="#"><span>quickview</span></a>
          ...
          <div class="product-item  product-item-opt-1 ">
            <div class="product-item-info">
              <div class="product-item-photo">
                <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor1-2.jpg')}}"></a>
                <div class="product-item-actions">
                  <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                  <a class="btn btn-compare" href="#"><span>compare</span></a>
                  <a class="btn btn-quickview" href="#"><span>quickview</span></a>
          ...
          <div class="product-item  product-item-opt-1 ">
            <div class="product-item-info">
              <div class="product-item-photo">
                <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor1-3.jpg')}}"></a>
                <div class="product-item-actions">
                  <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                  <a class="btn btn-compare" href="#"><span>compare</span></a>
                  <a class="btn btn-quickview" href="#"><span>quickview</span></a>
          ...
          <div class="product-item  product-item-opt-1 ">
            <div class="product-item-info">
              <div class="product-item-photo">
                <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor1-4.jpg')}}"></a>
                <div class="product-item-actions">
                  <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                  <a class="btn btn-compare" href="#"><span>compare</span></a>
                  <a class="btn btn-quickview" href="#"><span>quickview</span></a>
...
<div class="block-floor-products block-floor-products-opt1 floor-products2" id="floor0-2">
  <div class="container">
    <div class="block-title">
      <span class="title"><img alt="img"  src="{{asset('assets/front/images/media/index1/floor2.png')}}">Sports</span>
      <div class="links dropdown">
        <button class="dropdown-toggle"  type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <i class="fa fa-bars" aria-hidden="true"></i>
        </button>
    ...
    <div class="block-banner-floor">
      ...
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner2-1.jpg')}}" alt="banner"></a>
      </div>
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner2-2.jpg')}}" alt="banner"></a>
      </div>
    ...
    <div class="block-content">
      ...
      <div class="col-banner">
        <span class="label-featured"><img src="{{asset('assets/front/images/icon/index1/label-featured.png')}}" alt="label-featured"></span>
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/baner-floor2.jpg')}}" alt="baner-floor"></a>
      </div>
      ...
      <div class="col-products tab-content">
        ...
        <div class="product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor2-1.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class="product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor2-2.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class="product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor2-3.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class="product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor2-4.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
...
<div class="block-floor-products block-floor-products-opt1 floor-products3" id="floor0-3">
  <div class="container">
    <div class="block-title ">
      <span class="title"><img alt="img"  src="{{asset('assets/front/images/media/index1/floor3.png')}}">electronic</span>
      <div class="links dropdown">
        <button class="dropdown-toggle"  type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <i class="fa fa-bars" aria-hidden="true"></i>
        </button>
    ...
    <div class="block-banner-floor">
      ...
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner3-1.jpg')}}" alt="banner"></a>
      </div>
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner3-2.jpg')}}" alt="banner"></a>
      </div>
    ...
    <div class="block-content">
      ...
      <div class="col-banner">
        <span class="label-featured"><img src="{{asset('assets/front/images/icon/index1/label-featured.png')}}" alt="label-featured"></span>
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/baner-floor3.jpg')}}" alt="baner-floor"></a>
      </div>
      ...
      <div class="col-products tab-content">
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor3-1.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor3-2.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor3-3.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor3-4.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
...
<div class="block-floor-products block-floor-products-opt1 floor-products4" id="floor0-4">
  <div class="container">
    <div class="block-title ">
      <span class="title"><img alt="img"  src="{{asset('assets/front/images/media/index1/floor4.png')}}">Digital</span>
      <div class="links dropdown">
        <button class="dropdown-toggle"  type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <i class="fa fa-bars" aria-hidden="true"></i>
        </button>
    ...
    <div class="block-banner-floor">
      ...
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner4-1.jpg')}}" alt="banner"></a>
      </div>
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner4-2.jpg')}}" alt="banner"></a>
      </div>
    ...
    <div class="block-content">
      ...
      <div class="col-banner">
        <span class="label-featured"><img src="{{asset('assets/front/images/icon/index1/label-featured.png')}}" alt="label-featured"></span>
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/baner-floor4.jpg')}}" alt="baner-floor"></a>
      </div>
      ...
      <div class="col-products tab-content">
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor4-1.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor4-2.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class="product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor4-3.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor4-4.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
...
<div class="block-floor-products block-floor-products-opt1 floor-products5" id="floor0-5">
  <div class="container">
    <div class="block-title ">
      <span class="title"><img alt="img"  src="{{asset('assets/front/images/media/index1/floor5.png')}}">furniture</span>
      <div class="links dropdown">
        <button class="dropdown-toggle"  type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <i class="fa fa-bars" aria-hidden="true"></i>
        </button>
    ...
    <div class="block-banner-floor">
      ...
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner5-1.jpg')}}" alt="banner"></a>
      </div>
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner5-2.jpg')}}" alt="banner"></a>
      </div>
    ...
    <div class="block-content">
      ...
      <div class="col-banner">
        <span class="label-featured"><img src="{{asset('assets/front/images/icon/index1/label-featured.png')}}" alt="label-featured"></span>
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/baner-floor5.jpg')}}" alt="baner-floor"></a>
      </div>
      ...
      <div class="col-products tab-content">
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor5-1.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor5-2.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor5-3.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor5-4.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
...
<div class="block-floor-products block-floor-products-opt1 floor-products6" id="floor0-6">
  <div class="container">
    <div class="block-title ">
      <span class="title"><img alt="img"  src="{{asset('assets/front/images/media/index1/floor6.png')}}">jewelry</span>
      <div class="links dropdown">
        <button class="dropdown-toggle"  type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <i class="fa fa-bars" aria-hidden="true"></i>
        </button>
    ...
    <div class="block-banner-floor">
      ...
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner6-1.jpg')}}" alt="banner"></a>
      </div>
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner6-2.jpg')}}" alt="banner"></a>
      </div>
    ...
    <div class="block-content">
      ...
      <div class="col-banner">
        <span class="label-featured"><img src="{{asset('assets/front/images/icon/index1/label-featured.png')}}" alt="label-featured"></span>
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/baner-floor6.jpg')}}" alt="baner-floor"></a>
      </div>
      ...
      <div class="col-products tab-content">
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor6-1.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class="product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor6-2.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class=" product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor6-3.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
        ...
        <div class="product-item  product-item-opt-1 ">
          <div class="product-item-info">
            <div class="product-item-photo">
              <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/floor6-4.jpg')}}"></a>
              <div class="product-item-actions">
                <a class="btn btn-wishlist" href="#"><span>wishlist</span></a>
                <a class="btn btn-compare" href="#"><span>compare</span></a>
                <a class="btn btn-quickview" href="#"><span>quickview</span></a>
...
<div class="block-banner-opt1 effect-banner3">
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner7-1.jpg')}}" alt="banner"></a>
      </div>
      <div class="col-sm-6">
        <a href="#" class="box-img"><img src="{{asset('assets/front/images/media/index1/banner7-2.jpg')}}" alt="banner"></a>
      </div>
    </div>
  </div>
</div><!-- Banner -->
...
<div class="block-showcase block-showcase-opt1 block-brand-tabs">
  <div class="container">
    ...
    <li  class="active" data-tab="brand1-1">
      <img src="{{asset('assets/front/images/media/index1/brand-nav1.png')}}" alt="img">
    </li>
    <li   data-tab="brand1-2">
      <img src="{{asset('assets/front/images/media/index1/brand-nav2.png')}}" alt="img">
    </li>
    <li   data-tab="brand1-3">
      <img src="{{asset('assets/front/images/media/index1/brand-nav3.png')}}" alt="img">
    </li>
    <li   data-tab="brand1-4">
      <img src="{{asset('assets/front/images/media/index1/brand-nav4.png')}}" alt="img">
    </li>
    <li  data-tab="brand1-5">
      <img src="{{asset('assets/front/images/media/index1/brand-nav5.png')}}" alt="img">
    </li>
    <li   data-tab="brand1-6">
      <img src="{{asset('assets/front/images/media/index1/brand-nav6.png')}}" alt="img">
    </li>
    <li   data-tab="brand1-7">
      <img src="{{asset('assets/front/images/media/index1/brand-nav7.png')}}" alt="img">
    </li>
    <li   data-tab="brand1-8">
      <img src="{{asset('assets/front/images/media/index1/brand-nav8.png')}}" alt="img">
    </li>
    ...
    <div class="tab-pane active  " role="tabpanel" id="brand1-1">                        
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="col-title">
            <img src="{{asset('assets/front/images/media/index1/logo-showcase.jpg')}}" alt="logo" class="logo-showcase">
            <div class="des">
        ...
        <div class="col-md-8">  
          ...
          <div class="item">
            <div class="product-item  product-item-opt-1 ">
              <div class="product-item-info">
                <div class="product-item-photo">
                  <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/showcase1.jpg')}}" ></a>
                </div>
                <div class="product-item-detail">
                  <strong class="product-item-name"><a href="#">Maecenas consequat mauris</a></strong>
                  <div class="clearfix">
            ...
            <div class="product-item  product-item-opt-1 ">
              <div class="product-item-info">
                <div class="product-item-photo">
                  <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/showcase2.jpg')}}" ></a>
                </div>
                <div class="product-item-detail">
                  <strong class="product-item-name"><a href="#">Maecenas consequat mauris</a></strong>
                  <div class="clearfix">
          ...
          <div class="item">
            <div class="product-item  product-item-opt-1 ">
              <div class="product-item-info">
                <div class="product-item-photo">
                  <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/showcase3.jpg')}}" ></a>
                </div>
                <div class="product-item-detail">
                  <strong class="product-item-name"><a href="#">Maecenas consequat mauris</a></strong>
                  <div class="clearfix">
            ...
            <div class="product-item  product-item-opt-1 ">
              <div class="product-item-info">
                <div class="product-item-photo">
                  <a class="product-item-img" href="#"><img alt="product name" src="{{asset('assets/front/images/media/index1/showcase4.jpg')}}"></a>
                </div>
                <div class="product-item-detail">
                  <strong class="product-item-name"><a href="#">Maecenas consequat mauris</a></strong>
                  <div class="clearfix">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6">
          <div class="item">
            ...
            <div class="description" style="background-image: url(assets/front/images/media/index1/hot-categories1.png)">
          ...
          <div class="item">
            <div class="description" style="background-image: url(assets/front/images/media/index1/hot-categories2.png)">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="item">
            <div class="description" style="background-image: url(assets/front/images/media/index1/hot-categories3.png)">
          ...
          <div class="item">
            <div class="description" style="background-image: url(assets/front/images/media/index1/hot-categories4.png)">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="item">
            <div class="description" style="background-image: url(assets/front/images/media/index1/hot-categories5.png)">
          ...
          <div class="item">
            <div class="description" style="background-image: url(assets/front/images/media/index1/hot-categories6.png)">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="item">
            <div class="description" style="background-image: url(assets/front/images/media/index1/hot-categories7.png)">
          ...
          <div class="item">
            <div class="description" style="background-image: url(assets/front/images/media/index1/hot-categories8.png)">
...
<footer class="site-footer footer-opt-1">
  ...
  <div class="container">
      ...
      <div class="row">
        <div class="col-md-3 col-lg-3 col-xs-6 col">
          <strong class="logo-footer">
            <a href="#"><img src="{{asset('assets/front/images/media/index1/logo-footer.png')}}" alt="logo"></a>
          </strong>
    ...
    <div class="payment-methods">
      ...
      <div class="block-content">
        <img alt="payment" src="{{asset('assets/front/images/media/index1/payment1.png')}}">
        <img alt="payment" src="{{asset('assets/front/images/media/index1/payment2.png')}}">
        <img alt="payment" src="{{asset('assets/front/images/media/index1/payment3.png')}}">
        <img alt="payment" src="{{asset('assets/front/images/media/index1/payment4.png')}}">
        <img alt="payment" src="{{asset('assets/front/images/media/index1/payment5.png')}}">
        <img alt="payment" src="{{asset('assets/front/images/media/index1/payment6.png')}}">
        <img alt="payment" src="{{asset('assets/front/images/media/index1/payment7.png')}}">
        <img alt="payment" src="{{asset('assets/front/images/media/index1/payment8.png')}}">
        <img alt="payment" src="{{asset('assets/front/images/media/index1/payment9.png')}}">
        <img alt="payment" src="{{asset('assets/front/images/media/index1/payment10.png')}}">
      </div>
    </div>
    ...
    <div class="copyright">
      ...
      Copyright © 2018 Kutethemes. All Rights Reserved. Designed by <a href="http://kutethemes.com/">kutethemes.com</a>
...
<!-- actual --> 
<script type="text/javascript" src="{{asset('assets/front/js/jquery.actual.min.js')}}"></script>
<!-- jQuery UI -->
<script type="text/javascript" src="{{asset('assets/front/js/jquery-ui.min.js')}}"></script>
<!-- Chosen jquery-->    
<script type="text/javascript" src="{{asset('assets/front/js/chosen.jquery.min.js')}}"></script>
<!-- parallax jquery--> 
<script type="text/javascript" src="{{asset('assets/front/js/jquery.parallax-1.1.3.js')}}"></script>
<!-- elevatezoom --> 
<script type="text/javascript" src="{{asset('assets/front/js/jquery.elevateZoom.min.js')}}"></script>
<!-- fancybox -->
