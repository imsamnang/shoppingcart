      <div class="container">
        <a class="navbar-brand" href="#">
          <span class="logo">Tinhtoday Shopping Cart</span>
        </a>
          ...
          <ul class="nav navbar-nav pull-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu pull-right">
                <li>
                  <a href="http://localhost/project_full/stmav3/admin/users/profile/1">
                    <i class="fa fa-user"></i> Profile                                </a>
                  </li>
                  <li>
                    <a href="http://localhost/project_full/stmav3/admin/users/profile/1/#cpassword"><i class="fa fa-key"></i> Change Password                                </a>
                  </li>
                  <li class="divider"></li>
                  <li>
                    <a href="http://localhost/project_full/stmav3/admin/logout">
              ...
              <ul class="nav navbar-nav pull-right">
                <li class="dropdown hidden-xs"><a class="btn tip" title="Dashboard" data-placement="bottom" href="http://localhost/project_full/stmav3/admin/welcome"><i class="fa fa-dashboard"></i></a></li>
                <li class="dropdown hidden-sm">
                  <a class="btn tip" title="Settings" data-placement="bottom" href="http://localhost/project_full/stmav3/admin/system_settings">
                ...
                <li class="dropdown hidden-xs">
                  <a class="btn tip" title="Calendar" data-placement="bottom" href="http://localhost/project_full/stmav3/admin/calendar">
            ...
            <li class="dropdown hidden-xs">
              <a class="btn bdarkGreen tip" title="POS" data-placement="bottom" href="http://localhost/project_full/stmav3/admin/pos">
            ...
            <li class="dropdown">
              <a class="btn bdarkGreen tip" id="today_profit" title="<span>Today's Profit</span>"
                data-placement="bottom" data-html="true" href="http://localhost/project_full/stmav3/admin/reports/profit"
                data-toggle="modal" data-target="#myModal">
                <i class="fa fa-hourglass-2"></i>
              </a>
            </li>
            <li class="dropdown hidden-xs">
              <a class="btn bblue tip" title="List Open Registers" data-placement="bottom" href="http://localhost/project_full/stmav3/admin/pos/registers">
