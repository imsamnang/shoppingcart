...
<ul class="nav flaty-nav pull-right">
	...
	<li class="hidden-xs">
		...
		<ul class="dropdown-navbar dropdown-menu">
			...
			<li class="notify">
				<a href="#">
					<img src="{{asset('assets/flaty/img/demo/avatar/avatar2.jpg')}}" alt="Alex" />
	...
	<li class="hidden-xs">
		...
		<ul class="dropdown-navbar dropdown-menu">
			...
			<li class="msg">
				<a href="#">
					<img src="{{asset('assets/flaty/img/demo/avatar/avatar3.jpg')}}" alt="Sarah's Avatar" />
					<div>
			...
			<li class="msg">
				<a href="#">
					<img src="{{asset('assets/flaty/img/demo/avatar/avatar4.jpg')}}" alt="Emma's Avatar" />
					<div>
			...
			<li class="msg">
				<a href="#">
					<img src="{{asset('assets/flaty/img/demo/avatar/avatar5.jpg')}}" alt="John's Avatar" />
					<div>
	...
	<li class="user-profile">
		<a data-toggle="dropdown" href="#" class="user-menu dropdown-toggle">
			<img class="nav-user-photo" src="{{asset('assets/flaty/img/demo/avatar/avatar1.jpg')}}" alt="Penny's Photo" />
