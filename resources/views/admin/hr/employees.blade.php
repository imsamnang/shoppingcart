...
<form action="http://localhost/full_project/WeERP_v3/hr/employees_actions" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="d734af40612ff1684196bb5544ccb118" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i>List Employees</h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/hr/add_employee/">
                        ...
                        <li>
                            <a href="#" class="bpo"
								...
								<i class="fa fa-trash-o"></i> Delete Employees							</a>
						</li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="UsrTable1" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th style="width:150px;">Employee Date</th>							
