...
<form action="http://localhost/full_project/WeERP_v3/hr/position_actions" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="d734af40612ff1684196bb5544ccb118" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i>List Positions</h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/hr/add_position/" data-toggle="modal" data-target="#myModal">
                        ...
                        <li>
                            <a href="#" class="bpo"
								...
								<i class="fa fa-trash-o"></i> Delete Positions							</a>
						</li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="PositionTable" cellpadding="0" cellspacing="0" border="0"
