...
@section('title','Quantity Adjustment')
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-filter"></i>Quantity Adjustments (All Warehouses)</h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/products/add_adjustment">
                                <i class="fa fa-plus-circle"></i> Add Adjustment                            </a>
                        </li>
                        <!--<li>
                            <a href="http://localhost/full_project/WeERP_v3/products/add_adjustment_by_csv">
                                <i class="fa fa-plus-circle"></i> Add Adjustment by Excel                            </a>
                        </li>-->
                        <li>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" class="bpo" title="<b>Delete Quantity Adjustment</b>"
                            ...
                            <i class="fa fa-trash-o"></i> Delete Quantity Adjustment                             </a>
                         </li>
                    </ul>
                </li>
                                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="http://localhost/full_project/WeERP_v3/products/quantity_adjustments"><i class="fa fa-building-o"></i> All Warehouses</a></li>
                            <li class="divider"></li>
                            <li><a href="http://localhost/full_project/WeERP_v3/products/quantity_adjustments/3"><i class="fa fa-building"></i>Warehouse 1</a></li><li><a href="http://localhost/full_project/WeERP_v3/products/quantity_adjustments/4"><i class="fa fa-building"></i>Warehouse 2</a></li><li><a href="http://localhost/full_project/WeERP_v3/products/quantity_adjustments/5"><i class="fa fa-building"></i>Warehouse 3</a></li><li><a href="http://localhost/full_project/WeERP_v3/products/quantity_adjustments/6"><i class="fa fa-building"></i>Warehouse Siem Reap</a></li><li><a href="http://localhost/full_project/WeERP_v3/products/quantity_adjustments/7"><i class="fa fa-building"></i>3A-1234</a></li>                        </ul>
                    </li>
                            </ul>
        </div>
    </div>
