...
<form action="http://localhost/full_project/WeERP_v3/products/adjustment_actions" id="action-form" method="post" accept-charset="utf-8">
  ...
  <div class="box">
    <div class="box-header">
      <h2 class="blue"><i class="fa-fw fa fa-filter"></i>Using Stocks (All Warehouses)</h2>
      <div class="box-icon">
        <ul class="btn-tasks">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
              <li>
                <a href="http://localhost/full_project/WeERP_v3/products/add_using_stock">
                  <i class="fa fa-plus-circle"></i> Add Using Stock                            </a>
                </li>
                <li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                    <li><a href="http://localhost/full_project/WeERP_v3/products/using_stocks"><i class="fa fa-building-o"></i> All Warehouses</a></li>
                    <li class="divider"></li>
                    <li><a href="http://localhost/full_project/WeERP_v3/products/using_stocks/3"><i class="fa fa-building"></i>Warehouse 1</a></li><li><a href="http://localhost/full_project/WeERP_v3/products/using_stocks/4"><i class="fa fa-building"></i>Warehouse 2</a></li><li><a href="http://localhost/full_project/WeERP_v3/products/using_stocks/5"><i class="fa fa-building"></i>Warehouse 3</a></li><li><a href="http://localhost/full_project/WeERP_v3/products/using_stocks/6"><i class="fa fa-building"></i>Warehouse Siem Reap</a></li><li><a href="http://localhost/full_project/WeERP_v3/products/using_stocks/7"><i class="fa fa-building"></i>3A-1234</a></li>                        </ul>
                  </li>
                </ul>
              </div>
            </div>
