...
<form action="http://localhost/full_project/WeERP_v3/quotes/quote_actions" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="e300cefab404d51b08c0fbc7f15b818c" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart-o"></i>Quotations (All Warehouses)        </h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/quotes/add"><i class="fa fa-plus-circle"></i> Add Quotation                            </a>
                        </li>
                        <li>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" class="bpo" title="<b>Delete Quotations</b>" 
                                ...
                                data-html="true" data-placement="left"><i class="fa fa-trash-o"></i> Delete Quotations                            </a>
                        </li>
                    </ul>
                </li>
                                    <li class="dropdown">
