...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i>POS Sales (All Warehouses)        </h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="http://localhost/full_project/WeERP_v3/pos"><i class="fa fa-plus-circle"></i> Add Sale</a></li>
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="http://localhost/full_project/WeERP_v3/pos/sales"><i class="fa fa-building-o"></i> All Warehouses</a></li>
                            <li class="divider"></li>
                            <li><a href="http://localhost/full_project/WeERP_v3/pos/sales/3"><i class="fa fa-building"></i>Warehouse 1</a></li><li><a href="http://localhost/full_project/WeERP_v3/pos/sales/4"><i class="fa fa-building"></i>Warehouse 2</a></li><li><a href="http://localhost/full_project/WeERP_v3/pos/sales/5"><i class="fa fa-building"></i>Warehouse 3</a></li><li><a href="http://localhost/full_project/WeERP_v3/pos/sales/6"><i class="fa fa-building"></i>Warehouse Siem Reap</a></li><li><a href="http://localhost/full_project/WeERP_v3/pos/sales/7"><i class="fa fa-building"></i>3A-1234</a></li>                        </ul>
                    </li>
                            </ul>
        </div>
    </div>
                ...
                <div class="table-responsive">
                    <table id="POSData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
							...
							<th class="delivery_status">Delivery Status</th>
