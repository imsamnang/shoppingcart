...
<form action="http://localhost/full_project/WeERP_v3/sale_orders/sale_order_action" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="e300cefab404d51b08c0fbc7f15b818c" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart-o"></i>Sale Orders (All Warehouses)        </h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/sale_orders/add"><i class="fa fa-plus-circle"></i> Add Sale Order                            </a>
                        </li>
                        <li>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" class="bpo" title="<b>Delete Sale Orders</b>" 
                                ...
                                data-html="true" data-placement="left"><i class="fa fa-trash-o"></i> Delete Sale Orders                            </a>
                        </li>
                    </ul>
                </li>
                                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="http://localhost/full_project/WeERP_v3/sale_orders"><i class="fa fa-building-o"></i> All Warehouses</a></li>
                            <li class="divider"></li>
                            <li><a href="http://localhost/full_project/WeERP_v3/sale_orders/3"><i class="fa fa-building"></i>Warehouse 1</a></li><li><a href="http://localhost/full_project/WeERP_v3/sale_orders/4"><i class="fa fa-building"></i>Warehouse 2</a></li><li><a href="http://localhost/full_project/WeERP_v3/sale_orders/5"><i class="fa fa-building"></i>Warehouse 3</a></li><li><a href="http://localhost/full_project/WeERP_v3/sale_orders/6"><i class="fa fa-building"></i>Warehouse Siem Reap</a></li><li><a href="http://localhost/full_project/WeERP_v3/sale_orders/7"><i class="fa fa-building"></i>3A-1234</a></li>                        </ul>
                    </li>
                            </ul>
        </div>
    </div>
