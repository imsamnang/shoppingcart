...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-th-large"></i>Cash Book			 From 21/01/2019 to 21/01/2019		</h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <form action="http://localhost/full_project/WeERP_v3/accountings/cash_books" method="post" accept-charset="utf-8">
