...
<form action="http://localhost/full_project/WeERP_v3/customers/customer_actions" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="d734af40612ff1684196bb5544ccb118" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i>Customers</h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/customers/add" data-toggle="modal" data-target="#myModal" id="add">
                                <i class="fa fa-plus-circle"></i> Add Customer                            </a>
                        </li>
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/customers/import_csv" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus-circle"></i> Add Customers by Excel                            </a>
                        </li>
                                                <li>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" class="bpo" title="<b>Delete Customers</b>" 
                                ...
                                <i class="fa fa-trash-o"></i> Delete Customers                            </a>
                        </li>
                                            </ul>
                </li>
            </ul>
                ...
                <div class="table-responsive">
                    <table id="CusData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th style="min-width:135px !important;" class="text-center">Actions</th>
                        </tr>
                        </tfoot>
                    </table>
                </div>
