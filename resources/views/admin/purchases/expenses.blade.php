...
<form action="http://localhost/full_project/WeERP_v3/purchases/expense_actions" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="e300cefab404d51b08c0fbc7f15b818c" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i>Expenses</h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/purchases/add_expense" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus-circle"></i> Add Expense                            </a>
                        </li>
						<li class="hidden">
                            <a href="http://localhost/full_project/WeERP_v3/purchases/import_expenses" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> Import Expenses                            </a>
                        </li>
                        <li>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" class="bpo" title="<b>Delete Expenses</b>" 
                                ...
                                <i class="fa fa-trash-o"></i> Delete Expenses                            </a>
                        </li>
                    </ul>
                </li>
            </ul>
