...
<form action="http://localhost/full_project/WeERP_v3/system_settings/payment_term_actions" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="ebb5f994c18ca2edc3d2592a6f42ffff" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-building"></i>Payment Terms</h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="http://localhost/full_project/WeERP_v3/system_settings/add_payment_term" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> Add Payment Term</a>
                        </li>
                        ...
                        <li><a href="#" id="delete" data-action="delete"><i
                                    class="fa fa-trash-o"></i> Delete Payment Term</a></li>
