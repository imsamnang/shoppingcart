...
<form action="http://localhost/full_project/WeERP_v3/system_settings/category_actions" id="action-form" method="post" accept-charset="utf-8">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/system_settings/add_category" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> Add Category                            </a>
                        </li>
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/system_settings/import_categories" data-toggle="modal" data-target="#myModal">
