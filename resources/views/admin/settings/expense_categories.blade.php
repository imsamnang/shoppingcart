...
<form action="http://localhost/full_project/WeERP_v3/system_settings/expense_category_actions" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="d734af40612ff1684196bb5544ccb118" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i>Expense Categories</h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/system_settings/add_expense_category" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> Add Expense Category                            </a>
                        </li>
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/system_settings/import_expense_categories" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> Import Expense Categories                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> Delete Expense Categories                            </a>
                        </li>
                    </ul>
                </li>
            </ul>
