...
<form action="http://localhost/full_project/WeERP_v3/billers/biller_actions" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="d734af40612ff1684196bb5544ccb118" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i>Billers</h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
						                        <li><a href="http://localhost/full_project/WeERP_v3/billers/add" data-toggle="modal" data-target="#myModal" id="add"><i class="fa fa-plus-circle"></i> Add Biller</a></li>
                        ...
                        <li><a href="#" class="bpo" title="<b>Delete Billers</b>"
                               ...
                               data-html="true" data-placement="left"><i
                                    class="fa fa-trash-o"></i> Delete Billers</a></li>
						                    </ul>
                </li>
            </ul>
        </div>
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th></th>
                            <th></th>
                            <th style="width:85px;" class="text-center">Actions</th>
                        </tr>
                        </tfoot>
                    </table>
                </div>
