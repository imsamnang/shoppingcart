...
<form action="http://localhost/full_project/WeERP_v3/system_settings/loan_terms" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="d734af40612ff1684196bb5544ccb118" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i>Loan Terms</h2>
        <div class="box-icon">
            <ul class="btn-tasks">
				<li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/system_settings/add_loan_term" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> Add Loan Term                            </a>
                        </li>
					<ul>
				</li>
            </ul>
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="TaData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tbody>
                        <tr>
                            <td colspan="6" class="dataloan_terms_empty">Loading data from server</td>
                        </tr>
                        </tbody>
