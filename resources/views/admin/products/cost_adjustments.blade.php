...
@section('title','Cost Adjustments')
...
<form action="http://localhost/full_project/WeERP_v3/products/cost_adjustment_actions" id="action-form" method="post" accept-charset="utf-8">
<input type="hidden" name="token" value="2c684812a1d708ff68ef64c2082cd362" />
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-filter"></i>Cost Adjustments (All Warehouses)</h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="http://localhost/full_project/WeERP_v3/products/add_cost_adjustment">
                                <i class="fa fa-plus-circle"></i> Add Cost Adjustment                            </a>
                        </li>
                        <li>
