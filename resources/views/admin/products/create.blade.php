        ...
        <div class="col-lg-12">
          ...
          <form action="#" data-toggle="validator" role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            {{csrf_field()}}
              <div class="col-md-5">
                ...
                <div class="form-group all">
                  ...
                  <input type="text" name="name" value=""  class="form-control gen_slug" id="name" required="required" />
                </div>
                <div class="form-group all">
                ...
                <div class="form-group all">
                  ...
                  <input type="text" name="slug" value=""  class="form-control tip" id="slug" required="required" />
                </div>
                <div class="form-group all">
                  <label for="second_name">Secondary Name</label>                        
                  <input type="text" name="second_name" value=""  class="form-control tip" id="second_name" />
                </div>
                <div class="form-group standard_combo">
                  <label for="weight">Weight (kg)</label>                        
                  <input type="text" name="weight" value=""  class="form-control tip" id="weight" />
                </div>
                <div class="form-group all">
                ...
                <div class="form-group all">
                  ...
                  <select name="category" class="form-control select" id="category" placeholder="Select Category" required="required" style="width:100%">
                    <option value="" selected="selected"></option>
                ...
                <div class="form-group all">
                  ...
                  <div class="controls" id="subcat_data"> <input type="text" name="subcategory" value=""  class="form-control" id="subcategory"  placeholder="Please select category to load" />
                  </div>
                </div>
                <div class="form-group standard">
                  <label for="unit">Product Unit</label>
                  <select name="unit" class="form-control tip" id="unit" required="required" style="width:100%;">
                ...
                <div class="form-group standard">
                  ...
                  <input type="text" name="cost" value=""  class="form-control tip" id="cost" required="required" />
                </div>
                <div class="form-group all">
                  <label for="price">Product Price</label>                        
                  <input type="text" name="price" value=""  class="form-control tip" id="price" required="required" />
                </div>
                <div class="form-group">
                  <input type="checkbox" class="checkbox" value="1" name="promotion" id="promotion" >
                  <label for="promotion" class="padding05">Promotion</label>
                </div>
                <div id="promo" style="display:none;">
                  <div class="well well-sm">
                    <div class="form-group">
                      <label for="promo_price">Promotion Price</label>
                      <input type="text" name="promo_price" value=""  class="form-control tip" id="promo_price" />
                    </div>
                    <div class="form-group">
                      <label for="start_date">Start Date</label>                                
                      <input type="text" name="start_date" value=""  class="form-control tip date" id="start_date" />
                    </div>
                    <div class="form-group">
                      <label for="end_date">End Date</label>                                
                      <input type="text" name="end_date" value=""  class="form-control tip date" id="end_date" />
                    </div>
                  </div>
                </div>
                <div class="form-group all">
                  <label for="tax_rate">Product Tax</label>                            
                  <select name="tax_rate" class="form-control select" id="tax_rate" placeholder="Select Product Tax" style="width:100%">
                    <option value=""></option>
                ...
                <div class="form-group all">
                  ...
                  <select name="tax_method" class="form-control select" id="tax_method" placeholder="Select Tax Method" style="width:100%">
              ...
              <div class="form-group all">
                ...
                <input id="images" type="file" data-browse-label="Browse ..." name="userfile[]" multiple="true" data-show-upload="false"
            ...
            <div class="col-md-6 col-md-offset-1">
              <div class="standard">
                ...
                <div class="form-group">
                  ...
                  <label for="attributes" class="padding05">This product has multiple variants</label>
                  e.g. Multiple Sizes and/or Colors                        
                </div>
                ...
                <div class="">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="well">
                        <div class="col-md-6 col-sm-6 col-xs-6" style="padding-bottom:15px;">Warehouse 1<br>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <input type="text" name="rack_1" value=""  class="form-control" id="rack_1" placeholder="Racks" />
                          </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6" style="padding-bottom:15px;">Warehouse 2<br>  
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <input type="text" name="rack_2" value=""  class="form-control" id="rack_2" placeholder="Racks" />
                          </div>
                        </div>
              ...
              <div class="combo" style="display:none;">
                <div class="form-group">
                  <label for="add_item">Add Product</label> (Product without variants only)                            
              ...
              <div class="digital" style="display:none;">
                <div class="form-group digital">
                  <label for="digital_file">Digital File</label>                            
                  <input id="digital_file" type="file" data-browse-label="Browse ..." name="digital_file" data-show-upload="false"
                  data-show-preview="false" class="form-control file">
                </div>
                <div class="form-group">
                  <label for="file_link">File Link/URL</label>                            
                  <input type="text" name="file_link" value=""  class="form-control" id="file_link" />
                </div>
              </div>
              <div class="form-group standard">
                <div class="form-group">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <input name="hide" type="checkbox" class="checkbox" id="hide" value="1" />
                <label for="hide" class="padding05">Hide in Shop Module</label>
              </div>
              <div class="form-group">
